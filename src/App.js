            ...
            <div className="directions-content">
              ...
              >
                ...
                >
                  ...
                  <p className="direction-text">
                    ...
                    />
                    <br />
                    <strong>By Bus:</strong> Take bus to Avalurpettai via
                    Mangalam road, or ask for local bus to Mangalam from
                    Tiruvannamalai bus stand. Get down at Mangalam EB office
                    stop or Mangalam and walk back to Tiruvannamalai road 850
                    meters to reach the mahal.
                  </p>
              ...
              <AnimatedSection className="map-container">
                ...
                <p className="map-note">
                  📍 Gokul Tirumana Mahal A/C, Mangalam, Tiruvannamalai,
                  TamilNadu
                </p>
              </AnimatedSection>
            </div>
          ...
          <AnimatedSection>
            <div className="footer-content">
              ...
              <p className="footer-message">
                ...
                this new chapter of our lives. Your presence at our wedding
                would make our special day even more meaningful. We can't wait
